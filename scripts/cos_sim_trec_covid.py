...
logger.info("-------- Saving results in ./results/df_cos_sim_sc_{}.pkl --------".format(options.model))
os.makedirs("./results", exist_ok=True)
pickle.dump( corpus_score_sum, open( "./results/df_cos_sim_sc_" + options.model +".pkl", "wb" ) )      
